...
// @require      http://apps.bdimg.com/libs/jquery/1.7.2/jquery.min.js
// @grant        GM_log
// @grant        GM_addStyle
// ==/UserScript==
...
(function() {
    ...
    // Your code here...
    // https://stackoverflow.com/questions/7167085/on-append-do-something/7167210#7167210
    // (function($) {
    ...
    $(function(){
        var host_name = $('a.zb-name')[0].title;
        ...
        $("div#js-room-video").prepend(moveableDiv);
        
        setInterval(function(){
            $('font#hot')[0].innerText = $('span.hot-v')[0].innerText;
        }, 2000);
    });
    ...
    $(function(){
        var last_danmu = null;
        //$('ul.c-list').bind("append", function(event) {
        $('div.chat-cont-wrap').bind("scroll", function(event) {
            // GM_log('success');
            var danmu_list = $('ul.c-list')[1];
